...
public class IssueQueryCommand implements Command {
	...
	public String execute(String... args) throws Exception {
		...
		paramMap.put("asset_account", jsonObj.getString("asset_account"));
		paramMap.put("state", 0);
		paramMap.put("page_limit", jsonObj.getIntValue("page_limit"));
		paramMap.put("page_no", jsonObj.getIntValue("page_no"));
