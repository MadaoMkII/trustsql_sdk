...
public class IssueCashApplyCommand implements Command {
	...
	public String execute(String... args) throws Exception {
		...
		paramMap.put("owner_account", "1JCtadxaX85ZWSU1RbZwGvG5SC1tTkTQxy");
		paramMap.put("asset_type", "1");
		paramMap.put("amount", jsonObj.getString("amount"));
		paramMap.put("src_asset_list", jsonObj.getString("src_asset_list"));
