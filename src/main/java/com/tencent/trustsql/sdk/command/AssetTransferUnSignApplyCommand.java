...
public class AssetTransferUnSignApplyCommand implements Command {
    ...
    public String execute(String... args) throws Exception {
        ...
        String url = "https://baas.trustsql.qq.com/cgi-bin/v1.0/dam_asset_transfer_apply_v1.cgi";
