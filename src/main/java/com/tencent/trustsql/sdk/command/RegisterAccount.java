...
public class RegisterAccount implements Command {
    ...
    public String execute(String... args) throws Exception {
        ...
        String pubKey = "BAc72jJ+ZPXDVWt2ksz4vh+2bySDBfJGz+ByRQtrrE7nu/LUjWcOKTDT4cmZ8rW+NllhglNzMA7zSujT1FJxotg=";
        ...
        String url = "https://baas.trustsql.qq.com/idm_v1.1/api/account_cert/register";
